...
//             <div className="row">
//               <div className="col-md-6 mb-3"><label className="fw-bold">Medicine Name*</label><input  placeholder="Medicine Name" className="form-control" value={name} onChange={e => setName(e.target.value)} /></div>
//               <div className="col-md-6 mb-3"><label className="fw-bold">Manufacturer*</label><input    placeholder="Generic/Dublicate"  className="form-control" value={manufacturer} onChange={e => setManufacturer(e.target.value)} /></div>
//             </div>

//             <div className="row">
//               <div className="col-md-4 mb-3"><label className="fw-bold">UnitPrice*</label><input type="number" placeholder="price" className="form-control" value={unitPrice} onChange={e => setUnitPrice(e.target.value)} /></div>
//               <div className="col-md-4 mb-3"><label className="fw-bold">Discount (%)</label><input type="number" placeholder="Medicine Price Discount" className="form-control" value={discount} onChange={e => setDiscount(e.target.value)} /></div>
//               <div className="col-md-4 mb-3"><label className="fw-bold">Quantity*</label><input type="number" placeholder="MedicineQuantity" className="form-control" value={quantity} onChange={e => setQuantity(e.target.value)} /></div>
//             </div>
...
//                 </select>
//               </div>
//               <div className="col-md-4 mb-3"><label className="fw-bold">Medicine Type*</label><input placeholder="Tablet/Syrup/Capsule" className="form-control" value={medicinesType} onChange={e => setMedicinesType(e.target.value)} /></div>
//               <div className="col-md-4 mb-3"><label className="fw-bold">Category*</label><input placeholder="fever/pain...etc..Medicine" className="form-control" value={itemtype} onChange={e => setItemType(e.target.value)} /></div>
//             </div>
...
export default function Medicine() {
  ...
  const [name, setName] = useState("");
  const [manufacturer, setManufacturer] = useState("");
  const [onlyMgMedicine, setOnlyMgMedicine] = useState("");
  const [unitPrice, setUnitPrice] = useState("");
  const [discount, setDiscount] = useState("0");
  const [quantity, setQuantity] = useState("");
  const [expiryDate, setExpiryDate] = useState("");
  ...
  const handleSave = async () => {
    ...
    formData.append("Name", name.trim());
    formData.append("Manufacturer", manufacturer.trim());
    formData.append("OnlyMgMedicine", onlyMgMedicine.trim());
    formData.append("UnitPrice", unitPrice);
    formData.append("Discount", discount || 0);
    formData.append("Quantity", quantity);
    formData.append("ExpiryDate", toDdMmYyyy(expiryDate));
      ...
      <div style={{ marginLeft: '280px', padding: '20px', width: 'calc(100% - 280px)', minHeight: '100vh', display: 'flex', boxSizing: 'border-box' }}>
        <fieldset style={{ backgroundColor: 'white', padding: '30px', borderRadius: '15px', border: '1px solid #ddd', width: '100%', flex: '1', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', margin: '0' }}>
          <div>
            ...
            <div className="row">
              <div className="col-md-4 mb-3"><label className="fw-bold">Medicine Name*</label><input placeholder="Medicine Name" className="form-control" value={name} onChange={e => setName(e.target.value)} /></div>
              <div className="col-md-4 mb-3"><label className="fw-bold">Manufacturer*</label><input placeholder="Generic/Dublicate" className="form-control" value={manufacturer} onChange={e => setManufacturer(e.target.value)} /></div>
              <div className="col-md-4 mb-3"><label className="fw-bold">Only Mg Medicine</label><input placeholder="e.g. 500mg" className="form-control" value={onlyMgMedicine} onChange={e => setOnlyMgMedicine(e.target.value)} /></div>
            </div>
