        ...
        <div className="container-fluid px-4 px-md-5">
          <div className="row g-4">
            ...
            <div className="col-md-3">
              ...
              <p className="text-muted small mb-2">AKMedizostore Solutions Private Limited...</p>
              ...
              <p className="text-muted small mb-2">JS ROOP HOMES ,NEAR BY VIHAN HERITAGE SECTOR -1 GREATER NOIDA EXTENSION ,PINCODE- 201318</p>
              <p className="text-muted small mb-1"><strong>CIN:</strong> 0000000</p>
              <p className="text-muted small mb-3"><strong>Telephone:</strong> 8409844260</p>
              ...
              <p className="text-muted small mb-0"><a href="mailto:grievance-customersupports01@gmail.com" className="text-decoration-none">grievance-customersupports01@gmail.com</a></p>
            </div>
